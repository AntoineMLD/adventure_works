...
class SASSamples:
    ...
    def generate_sas_url(self, blob_service_client):
        ...
        # Extraire la clé de l'environnement
        ...
        # Construire l'URL avec le SAS token
...
if __name__ == '__main__':
    ...
    # Configurer le client BlobServiceClient
    ...
    # Sauvegarder l'URL SAS dans un fichier ou l'afficher
