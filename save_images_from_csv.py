...
def save_image_from_bytes(image_bytes, item_id, output_dir, image_format='PNG', metadata=None):
    ...
    try:
        ...
        # Sauvegarde l'image en format spécifié (PNG ou JPEG)
...
def process_csv(csv_file, output_dir, image_format='PNG'):
    ...
    for index, row in df.iterrows():
        ...
        # Converti les bytes de l'image de la chaîne
        image_bytes = eval(image_bytes_str)['bytes']  
        
        # Sauvegarde l'image et ses métadonnées
